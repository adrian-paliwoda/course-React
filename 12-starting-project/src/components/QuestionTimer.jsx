...
export default function QuestionTimer({ onTimeout, timeoutForAnswer = 15000, mode }) {
  ...
  return <progress id="question-time" max={timeoutForAnswer} value={remainingTime} className={mode} />;
}
